...
import { ClientPluginManifest, PluginManifest, PluginsResponse, PluginStatus } from 'types/plugins';
...
export default class Client4 {
  ...
  patchMe = (userPatch: Partial<UserProfile>) => {
    return this.doFetch<UserProfile>(`${this.getUserRoute('me')}/patch`, {
      method: 'put',
  ...
  patchUser = (userPatch: Partial<UserProfile> & { id: string }) => {
    ...
    return this.doFetch<UserProfile>(`${this.getUserRoute(userPatch.id)}/patch`, {
      method: 'put',
      body: JSON.stringify(userPatch),
    });
  };
  ...
  updateUser = (user: UserProfile) => {
    ...
    return this.doFetch<UserProfile>(`${this.getUserRoute(user.id)}`, {
      method: 'put',
      body: JSON.stringify(user),
    });
  };
  ...
  updateUserRoles = (userId: string, roles: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getUserRoute(userId)}/roles`, {
      method: 'put',
  ...
  updateUserMfa = (userId: string, activate: boolean, code: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getUserRoute(userId)}/mfa`, {
      method: 'put',
  ...
  getKnownUsers = () => {
    ...
    return this.doFetch<Array<$ID<UserProfile>>>(`${this.getUsersRoute()}/known`, {
      method: 'get',
    });
  };
  ...
  sendPasswordResetEmail = (email: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getUsersRoute()}/password/reset/send`, {
      method: 'post',
  ...
  updateUserActive = (userId: string, active: boolean) => {
    ...
    return this.doFetch<StatusOK>(`${this.getUserRoute(userId)}/active`, {
      method: 'put',
  ...
  verifyUserEmail = (token: string) => {
    return this.doFetch<StatusOK>(`${this.getUsersRoute()}/email/verify`, {
      method: 'post',
  ...
  updateMyTermsOfServiceStatus = (termsOfServiceId: string, accepted: boolean) => {
    return this.doFetch<StatusOK>(`${this.getUserRoute('me')}/terms_of_service`, {
      method: 'post',
      body: JSON.stringify({ termsOfServiceId, accepted }),
    });
  };

  getTermsOfService = () => {
    return this.doFetch<TermsOfService>(`${this.getBaseRoute()}/terms_of_service`, {
      method: 'get',
    });
  };
  ...
  sendVerificationEmail = (email: string) => {
    return this.doFetch<StatusOK>(`${this.getUsersRoute()}/email/verify/send`, {
      method: 'post',
      body: JSON.stringify({ email }),
    });
  };
  ...
  login = (loginId: string, password: string, token = '', deviceId = '', ldapOnly = false) => {
    ...
    return this.doFetch<UserProfile>(`${this.getUsersRoute()}/login`, {
      method: 'post',
      body: JSON.stringify(body),
    });
  };
  ...
  getProfilesByUsernames = (usernames: string[]) => {
    ...
    return this.doFetch<UserProfile[]>(`${this.getUsersRoute()}/usernames`, {
      method: 'post',
  ...
  getUserByUsername = (username: string) => {
    return this.doFetch<UserProfile>(`${this.getUsersRoute()}/username/${username}`, {
      method: 'get',
    });
  };
  ...
  revokeAllSessionsForUser = (userId: string) => {
    return this.doFetch<StatusOK>(`${this.getUserRoute(userId)}/sessions/revoke/all`, {
      method: 'post',
    });
  };

  revokeSessionsForAllUsers = () => {
    return this.doFetch<StatusOK>(`${this.getUsersRoute()}/sessions/revoke/all`, {
      method: 'post',
    });
  };
  ...
  searchUsers = (term: string, options: any) => {
    ...
    return this.doFetch<UserProfile[]>(`${this.getUsersRoute()}/search`, {
      method: 'post',
      body: JSON.stringify({ term, ...options }),
    });
  };

  getStatusesByIds = (userIds: string[]) => {
    return this.doFetch<UserStatus[]>(`${this.getUsersRoute()}/status/ids`, {
      method: 'post',
      body: JSON.stringify(userIds),
    });
  };
  ...
  updateStatus = (status: UserStatus) => {
    return this.doFetch<UserStatus>(`${this.getUserRoute(status.user_id)}/status`, {
      method: 'put',
  ...
  updateCustomStatus = (customStatus: UserCustomStatus) => {
    return this.doFetch(`${this.getUserRoute('me')}/status/custom`, {
      method: 'put',
  ...
  removeRecentCustomStatus = (customStatus: UserCustomStatus) => {
    return this.doFetch(`${this.getUserRoute('me')}/status/custom/recent`, {
      method: 'delete',
      body: JSON.stringify(customStatus),
    });
  };
  ...
  getAuthorizedOAuthApps = (userId: string) => {
    return this.doFetch<OAuthApp[]>(`${this.getUserRoute(userId)}/oauth/apps/authorized`, {
      method: 'get',
    });
  };
  ...
  deauthorizeOAuthApp = (clientId: string) => {
    return this.doFetch<StatusOK>(`${this.url}/oauth/deauthorize`, {
      method: 'post',
  ...
  getUserAccessToken = (tokenId: string) => {
    return this.doFetch<UserAccessToken>(`${this.getUsersRoute()}/tokens/${tokenId}`, {
      method: 'get',
    });
  };
  ...
  createTeam = (team: Team) => {
    ...
    return this.doFetch<Team>(`${this.getTeamsRoute()}`, {
      method: 'post',
  ...
  updateTeam = (team: Team) => {
    ...
    return this.doFetch<Team>(`${this.getTeamRoute(team.id)}`, {
      method: 'put',
      body: JSON.stringify(team),
    });
  };
  ...
  patchTeam = (team: Partial<Team> & { id: string }) => {
    ...
    return this.doFetch<Team>(`${this.getTeamRoute(team.id)}/patch`, {
      method: 'put',
      body: JSON.stringify(team),
    });
  };
  ...
  regenerateTeamInviteId = (teamId: string) => {
    ...
    return this.doFetch<Team>(`${this.getTeamRoute(teamId)}/regenerate_invite_id`, {
      method: 'post',
    });
  };
  ...
  updateTeamScheme = (teamId: string, schemeId: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getTeamSchemeRoute(teamId)}`, {
      method: 'put',
  ...
  checkIfTeamExists = (teamName: string) => {
    return this.doFetch<{ exists: boolean }>(`${this.getTeamNameRoute(teamName)}/exists`, {
      method: 'get',
    });
  };
  ...
  getMyTeamMembers = () => {
    return this.doFetch<TeamMembership[]>(`${this.getUserRoute('me')}/teams/members`, {
      method: 'get',
    });
  };

  getMyTeamUnreads = () => {
    return this.doFetch<TeamUnread[]>(`${this.getUserRoute('me')}/teams/unread`, { method: 'get' });
  };
  ...
  getTeamMembers = (
    ...
    return this.doFetch<TeamMembership>(
      `${this.getTeamMembersRoute(teamId)}${buildQueryString({
        page,
        per_page: perPage,
        ...options,
      })}`,
  ...
  getTeamMembersForUser = (userId: string) => {
    return this.doFetch<TeamMembership[]>(`${this.getUserRoute(userId)}/teams/members`, {
      method: 'get',
    });
  };

  getTeamMember = (teamId: string, userId: string) => {
    return this.doFetch<TeamMembership>(`${this.getTeamMemberRoute(teamId, userId)}`, {
      method: 'get',
    });
  };
  ...
  addToTeam = (teamId: string, userId: string) => {
    ...
    return this.doFetch<TeamMembership>(`${this.getTeamMembersRoute(teamId)}`, {
      method: 'post',
  ...
  addToTeamFromInvite = (token = '', inviteId = '') => {
    ...
    return this.doFetch<TeamMembership>(`${this.getTeamsRoute()}/members/invite${query}`, {
      method: 'post',
    });
  };
  ...
  removeFromTeam = (teamId: string, userId: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getTeamMemberRoute(teamId, userId)}`, {
      method: 'delete',
    });
  };
  ...
  sendEmailInvitesToTeam = (teamId: string, emails: string[]) => {
    ...
    return this.doFetch<StatusOK>(`${this.getTeamRoute(teamId)}/invite/email`, {
      method: 'post',
  ...
  sendEmailGuestInvitesToChannels = (
    ...
    return this.doFetch<StatusOK>(`${this.getTeamRoute(teamId)}/invite-guests/email`, {
      method: 'post',
      body: JSON.stringify({ emails, channels: channelIds, message }),
    });
  };
  ...
  importTeam = (teamId: string, file: File, importFrom: string) => {
    ...
    return this.doFetch<{
      results: string;
    }>(`${this.getTeamRoute(teamId)}/import`, request);
  };
  ...
  createChannel = (channel: Channel) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelsRoute()}`, {
      method: 'post',
  ...
  createDirectChannel = (userIds: string[]) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelsRoute()}/direct`, {
      method: 'post',
      body: JSON.stringify(userIds),
    });
  };
  ...
  createGroupChannel = (userIds: string[]) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelsRoute()}/group`, {
      method: 'post',
      body: JSON.stringify(userIds),
    });
  };
  ...
  unarchiveChannel = (channelId: string) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelRoute(channelId)}/restore`, { method: 'post' });
  };

  updateChannel = (channel: Channel) => {
    this.trackEvent('api', 'api_channels_update', { channel_id: channel.id });

    return this.doFetch<Channel>(`${this.getChannelRoute(channel.id)}`, {
      method: 'put',
      body: JSON.stringify(channel),
    });
  };
  ...
  convertChannelToPrivate = (channelId: string) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelRoute(channelId)}/convert`, { method: 'post' });
  };
  ...
  updateChannelPrivacy = (channelId: string, privacy: any) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelRoute(channelId)}/privacy`, {
      method: 'put',
  ...
  patchChannel = (channelId: string, channelPatch: Partial<Channel>) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelRoute(channelId)}/patch`, {
      method: 'put',
  ...
  updateChannelNotifyProps = (props: any) => {
    this.trackEvent('api', 'api_users_update_channel_notifications', {
  ...
  updateChannelScheme = (channelId: string, schemeId: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getChannelSchemeRoute(channelId)}`, {
      method: 'put',
      body: JSON.stringify(patch),
    });
  };
  ...
  getChannel = (channelId: string) => {
    ...
    return this.doFetch<Channel>(`${this.getChannelRoute(channelId)}`, { method: 'get' });
  };
  ...
  getChannelByNameAndTeamName = (teamName: string, channelName: string, includeDeleted = false) => {
    ...
    return this.doFetch<Channel>(
      `${this.getTeamNameRoute(
        teamName
      )}/channels/name/${channelName}?include_deleted=${includeDeleted}`,
      { method: 'get' }
    );
  };
  ...
  getMyChannelMember = (channelId: string) => {
    return this.doFetch<ChannelMembership>(`${this.getChannelMemberRoute(channelId, 'me')}`, {
      method: 'get',
    });
  };
  ...
  getChannelTimezones = (channelId: string) => {
    return this.doFetch<string[]>(`${this.getChannelRoute(channelId)}/timezones`, {
      method: 'get',
    });
  };

  getChannelMember = (channelId: string, userId: string) => {
    return this.doFetch<ChannelMembership>(`${this.getChannelMemberRoute(channelId, userId)}`, {
      method: 'get',
    });
  };
  ...
  removeFromChannel = (userId: string, channelId: string) => {
    ...
    return this.doFetch<StatusOK>(`${this.getChannelMemberRoute(channelId, userId)}`, {
      method: 'delete',
    });
  };
  ...
  getChannelStats = (channelId: string) => {
    return this.doFetch<ChannelStats>(`${this.getChannelRoute(channelId)}/stats`, {
      method: 'get',
    });
  };

  getChannelModerations = (channelId: string) => {
    return this.doFetch<ChannelModeration[]>(`${this.getChannelRoute(channelId)}/moderations`, {
      method: 'get',
    });
  };
  ...
  getChannelMemberCountsByGroup = (channelId: string, includeTimezones: boolean) => {
    return this.doFetch<ChannelMemberCountsByGroup>(
      `${this.getChannelRoute(
        channelId
      )}/member_counts_by_group?include_timezones=${includeTimezones}`,
      { method: 'get' }
    );
  };
  ...
  searchChannels = (teamId: string, term: string) => {
    return this.doFetch<Channel[]>(`${this.getTeamRoute(teamId)}/channels/search`, {
      method: 'post',
  ...
  searchGroupChannels = (term: string) => {
    return this.doFetch<Channel[]>(`${this.getChannelsRoute()}/group/search`, {
      method: 'post',
      body: JSON.stringify({ term }),
    });
  };
  ...
  createPost = async (post: Post) => {
    const result = await this.doFetch<Post>(`${this.getPostsRoute()}`, {
      method: 'post',
  ...
  updatePost = (post: Post) => {
    ...
    return this.doFetch<Post>(`${this.getPostRoute(post.id)}`, {
      method: 'put',
      body: JSON.stringify(post),
    });
  };
  ...
  patchPost = (postPatch: Partial<Post> & { id: string }) => {
    ...
    return this.doFetch<Post>(`${this.getPostRoute(postPatch.id)}/patch`, {
      method: 'put',
  ...
  getPostsUnread = (
    channelId: string,
    userId: string,
    limitAfter = DEFAULT_LIMIT_AFTER,
    limitBefore = DEFAULT_LIMIT_BEFORE,
    fetchThreads = true,
    collapsedThreads = false,
    collapsedThreadsExtended = false
  ) => {
    return this.doFetch<PostList>(
      `${this.getUserRoute(userId)}/channels/${channelId}/posts/unread${buildQueryString({
  ...
  getUserThreads = (
    ...
    return this.doFetch<UserThreadList>(
      `${this.getUserThreadsRoute(userId, teamId)}${buildQueryString({
        before,
        after,
        pageSize,
        extended,
  ...
  getUserThread = (userId: string, teamId: string, threadId: string, extended = false) => {
    ...
    return this.doFetch<UserThreadWithPost>(`${url}${buildQueryString({ extended })}`, {
      method: 'get',
    });
  };
  ...
  updateThreadReadForUser = (
    ...
    return this.doFetch<UserThread>(url, { method: 'put' });
  };
  ...
  updateThreadFollowForUser = (
    ...
    return this.doFetch<StatusOK>(url, { method: state ? 'put' : 'delete' });
  };
  ...
  searchPostsWithParams = (teamId: string, params: any) => {
    ...
    return this.doFetch<PostSearchResults>(`${this.getTeamRoute(teamId)}/posts/search`, {
      method: 'post',
  ...
  getOpenGraphMetadata = (url: string) => {
    return this.doFetch<OpenGraphMetadata>(`${this.getBaseRoute()}/opengraph`, {
      method: 'post',
  ...
  savePreferences = (userId: string, preferences: PreferenceType[]) => {
    return this.doFetch<StatusOK>(`${this.getPreferencesRoute(userId)}`, {
      method: 'put',
  ...
  upgradeToEnterprise = async () => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/upgrade_to_enterprise`, {
      method: 'post',
    });
  };
  ...
  createIncomingWebhook = (hook: IncomingWebhook) => {
    ...
    return this.doFetch<IncomingWebhook>(`${this.getIncomingHooksRoute()}`, {
      method: 'post',
  ...
  updateIncomingWebhook = (hook: IncomingWebhook) => {
    ...
    return this.doFetch<IncomingWebhook>(`${this.getIncomingHookRoute(hook.id)}`, {
      method: 'put',
      body: JSON.stringify(hook),
    });
  };
  ...
  createOutgoingWebhook = (hook: OutgoingWebhook) => {
    ...
    return this.doFetch<OutgoingWebhook>(`${this.getOutgoingHooksRoute()}`, {
      method: 'post',
      body: JSON.stringify(hook),
    });
  };
  ...
  updateOutgoingWebhook = (hook: OutgoingWebhook) => {
    ...
    return this.doFetch<OutgoingWebhook>(`${this.getOutgoingHookRoute(hook.id)}`, {
      method: 'put',
      body: JSON.stringify(hook),
    });
  };
  ...
  regenOutgoingHookToken = (id: string) => {
    return this.doFetch<OutgoingWebhook>(`${this.getOutgoingHookRoute(id)}/regen_token`, {
      method: 'post',
    });
  };

  getCommandsList = (teamId: string) => {
    return this.doFetch<Command[]>(`${this.getCommandsRoute()}?team_id=${teamId}`, {
      method: 'get',
    });
  };
  ...
  addCommand = (command: Command) => {
    ...
    return this.doFetch<Command>(`${this.getCommandsRoute()}`, {
      method: 'post',
  ...
  editCommand = (command: Command) => {
    ...
    return this.doFetch<Command>(`${this.getCommandsRoute()}/${command.id}`, {
      method: 'put',
      body: JSON.stringify(command),
    });
  };
  ...
  createOAuthApp = (app: OAuthApp) => {
    ...
    return this.doFetch<OAuthApp>(`${this.getOAuthAppsRoute()}`, {
      method: 'post',
  ...
  editOAuthApp = (app: OAuthApp) => {
    return this.doFetch<OAuthApp>(`${this.getOAuthAppsRoute()}/${app.id}`, {
      method: 'put',
      body: JSON.stringify(app),
    });
  };
  ...
  regenOAuthAppSecret = (appId: string) => {
    return this.doFetch<OAuthApp>(`${this.getOAuthAppRoute(appId)}/regen_secret`, {
      method: 'post',
    });
  };
  ...
  getCustomEmojiByName = (name: string) => {
    return this.doFetch<CustomEmoji>(`${this.getEmojisRoute()}/name/${name}`, { method: 'get' });
  };
  ...
  getTimezones = () => {
    return this.doFetch<string[]>(`${this.getTimezonesRoute()}`, { method: 'get' });
  };

  // Data Retention

  getDataRetentionPolicy = () => {
    return this.doFetch<DataRetentionPolicy>(`${this.getDataRetentionRoute()}/policy`, {
      method: 'get',
    });
  };
  ...
  searchDataRetentionCustomPolicyChannels = (
    policyId: string,
    term: string,
  ...
  getDataRetentionCustomPolicyTeams = (
    ...
    return this.doFetch<Team[]>(
      `${this.getDataRetentionRoute()}/policies/${id}/teams${buildQueryString({
        page,
        per_page: perPage,
        include_total_count: includeTotalCount,
      })}`,
  ...
  getDataRetentionCustomPolicyChannels = (id: string, page = 0, perPage = PER_PAGE_DEFAULT) => {
    return this.doFetch<{ channels: Channel[]; total_count: number }>(
      `${this.getDataRetentionRoute()}/policies/${id}/channels${buildQueryString({
        page,
        per_page: perPage,
      })}`,
      { method: 'get' }
  ...
  removeDataRetentionPolicyChannels = (
    id: string,
    policy: PatchDataRetentionCustomPolicyChannels
  ) => {
    return this.doFetch<DataRetentionCustomPolicies>(
      `${this.getDataRetentionRoute()}/policies/${id}/channels`,
      { method: 'delete', body: JSON.stringify(policy) }
  ...
  createJob = (job: Job) => {
    return this.doFetch<Job>(`${this.getJobsRoute()}`, {
      method: 'post',
  ...
  updateConfig = (config: AdminConfig) => {
    return this.doFetch<AdminConfig>(`${this.getBaseRoute()}/config`, {
      method: 'put',
  ...
  getEnvironmentConfig = () => {
    return this.doFetch<EnvironmentConfig>(`${this.getBaseRoute()}/config/environment`, {
      method: 'get',
    });
  };

  testEmail = (config: AdminConfig) => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/email/test`, {
      method: 'post',
      body: JSON.stringify(config),
    });
  };
  ...
  testS3Connection = (config: ClientConfig) => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/file/s3_test`, {
      method: 'post',
      body: JSON.stringify(config),
    });
  };
  ...
  createComplianceReport = (job: Partial<Compliance>) => {
    return this.doFetch<Compliance>(`${this.getBaseRoute()}/compliance/reports`, {
      method: 'post',
      body: JSON.stringify(job),
    });
  };
  ...
  getComplianceReport = (reportId: string) => {
    return this.doFetch<Compliance>(`${this.getBaseRoute()}/compliance/reports/${reportId}`, {
      method: 'get',
    });
  };
  ...
  linkLdapGroup = (key: string) => {
    return this.doFetch<Group>(`${this.getBaseRoute()}/ldap/groups/${encodeURI(key)}/link`, {
      method: 'post',
    });
  };

  unlinkLdapGroup = (key: string) => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/ldap/groups/${encodeURI(key)}/link`, {
      method: 'delete',
    });
  };

  getSamlCertificateStatus = () => {
    return this.doFetch<SamlCertificateStatus>(`${this.getBaseRoute()}/saml/certificate/status`, {
      method: 'get',
    });
  };
  ...
  testElasticsearch = (config: ClientConfig) => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/elasticsearch/test`, {
      method: 'post',
      body: JSON.stringify(config),
    });
  };
  ...
  purgeElasticsearchIndexes = () => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/elasticsearch/purge_indexes`, {
      method: 'post',
    });
  };

  purgeBleveIndexes = () => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/bleve/purge_indexes`, { method: 'post' });
  };
  ...
  removeLicense = () => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/license`, { method: 'delete' });
  };
  ...
  getRolesByNames = (rolesNames: string[]) => {
    return this.doFetch<Role[]>(`${this.getRolesRoute()}/names`, {
      method: 'post',
  ...
  patchRole = (roleId: string, rolePatch: Partial<Role>) => {
    return this.doFetch<Role>(`${this.getRolesRoute()}/${roleId}/patch`, {
      method: 'put',
  ...
  createScheme = (scheme: Scheme) => {
    ...
    return this.doFetch<Scheme>(`${this.getSchemesRoute()}`, {
      method: 'post',
  ...
  patchScheme = (schemeId: string, schemePatch: Partial<Scheme>) => {
    ...
    return this.doFetch<Scheme>(`${this.getSchemesRoute()}/${schemeId}/patch`, {
      method: 'put',
  ...
  getMarketplacePlugins = (filter: string, localOnly = false) => {
    return this.doFetch<MarketplacePlugin[]>(
      `${this.getPluginsMarketplaceRoute()}${buildQueryString({
        filter: filter || '',
  ...
  getWebappPlugins = () => {
    return this.doFetch<ClientPluginManifest[]>(`${this.getPluginsRoute()}/webapp`, {
      method: 'get',
    });
  };
  ...
  getGroupSyncables = (groupID: string, syncableType: string) => {
    return this.doFetch<GroupSyncable[]>(`${this.getGroupRoute(groupID)}/${syncableType}s`, {
      method: 'get',
    });
  };

  getGroup = (groupID: string) => {
    return this.doFetch<Group>(this.getGroupRoute(groupID), { method: 'get' });
  };
  ...
  getGroupsNotAssociatedToChannel = (
    ...
    return this.doFetch<Group[]>(`${this.getGroupsRoute()}${buildQueryString(query)}`, {
      method: 'get',
    });
  };
  ...
  getAppsBindings = async (userID: string, channelID: string) => {
    return this.doFetch<AppBinding[]>(
      this.getAppsProxyRoute() +
        `/api/v1/bindings?user_id=${userID}&channel_id=${channelID}&user_agent_type=webapp`,
      { method: 'get' }
    );
  };
  ...
  patchGroup = (groupID: string, patch: GroupPatch) => {
    return this.doFetch<Group>(`${this.getGroupRoute(groupID)}/patch`, {
      method: 'put',
      body: JSON.stringify(patch),
    });
  };
  ...
  createBot = (bot: Bot) => {
    return this.doFetch<Bot>(`${this.getBotsRoute()}`, {
      method: 'post',
  ...
  patchBot = (botUserId: string, botPatch: BotPatch) => {
    return this.doFetch<Bot>(`${this.getBotRoute(botUserId)}`, {
      method: 'put',
  ...
  getBotsIncludeDeleted = (page = 0, perPage = PER_PAGE_DEFAULT) => {
    return this.doFetch<Bot[]>(
      `${this.getBotsRoute()}${buildQueryString({
  ...
  assignBot = (botUserId: string, newOwnerId: string) => {
    return this.doFetch<Bot>(`${this.getBotRoute(botUserId)}/assign/${newOwnerId}`, {
      method: 'post',
    });
  };
  ...
  // Cloud routes
  getCloudProducts = () => {
    return this.doFetch<Product[]>(`${this.getCloudRoute()}/products`, { method: 'get' });
  };
  ...
  updateCloudCustomer = (customerPatch: CloudCustomerPatch) => {
    return this.doFetch<CloudCustomer>(`${this.getCloudRoute()}/customer`, {
      method: 'put',
  ...
  updateCloudCustomerAddress = (address: Address) => {
    return this.doFetch<CloudCustomer>(`${this.getCloudRoute()}/customer/address`, {
      method: 'put',
  ...
  confirmPaymentMethod = async (stripeSetupIntentID: string) => {
    return this.doFetch(`${this.getCloudRoute()}/payment/confirm`, {
      method: 'post',
      body: JSON.stringify({ stripe_setup_intent_id: stripeSetupIntentID }),
    });
  };

  getSubscription = () => {
    return this.doFetch<Subscription>(`${this.getCloudRoute()}/subscription`, { method: 'get' });
  };

  getSubscriptionStats = () => {
    return this.doFetch<SubscriptionStats>(`${this.getCloudRoute()}/subscription/stats`, {
      method: 'get',
    });
  };

  getRenewalLink = () => {
    return this.doFetch<{ renewal_link: string }>(`${this.getBaseRoute()}/license/renewal`, {
      method: 'get',
    });
  };

  getInvoices = () => {
    return this.doFetch<Invoice[]>(`${this.getCloudRoute()}/subscription/invoices`, {
      method: 'get',
    });
  };
  ...
  getSamlMetadataFromIdp = (samlMetadataURL: string) => {
    return this.doFetch<SamlMetadataResponse>(`${this.getBaseRoute()}/saml/metadatafromidp`, {
      method: 'post',
      body: JSON.stringify({ saml_metadata_url: samlMetadataURL }),
    });
  };
  ...
  updateNoticesAsViewed = (noticeIds: string[]) => {
    ...
    return this.doFetch<StatusOK>(`${this.getNoticesRoute()}/view`, {
      method: 'put',
  ...
  sendAdminUpgradeRequestEmail = () => {
    return this.doFetch<StatusOK>(`${this.getCloudRoute()}/subscription/limitreached/invite`, {
      method: 'post',
    });
  };

  sendAdminUpgradeRequestEmailOnJoin = () => {
    return this.doFetch<StatusOK>(`${this.getCloudRoute()}/subscription/limitreached/join`, {
      method: 'post',
    });
  };
  ...
  trackEvent(category: string, event: string, props?: any) {
    if (this.telemetryHandler) {
      const userRoles =
        this.userRoles && isSystemAdmin(this.userRoles)
